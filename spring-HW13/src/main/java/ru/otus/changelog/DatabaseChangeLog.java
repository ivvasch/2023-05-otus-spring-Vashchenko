...
//
//    public DatabaseChangeLog(PasswordEncoder passwordEncoder) {
...
//    }
    ...
    @ChangeSet(order = "006", id = "insertUser", author = "ivvasch", runAlways = true)
    public void insertUser(UserRepository userRepository) {
        PasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
        User user = new User();
        user.setName("ivan");
        user.setPassword(passwordEncoder.encode("navi"));
        user.setRole("USER");
