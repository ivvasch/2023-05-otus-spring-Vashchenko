...
class AuthorServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        author = new Author("255be70b-a76a-4eda-8892-b8e929780bfb", "Herbert George Wells", new ArrayList<>());
    }
    ...
    void shouldSaveAuthorCorrect() {
        ...
        assertEquals(author.getBooks().size(), saveResult.getBooks().size());
    ...
    void shouldUpdateAuthorNameService() {
        ...
        author = new Author("255be70b-a76a-4eda-8892-b8e929780bfb", newName, new ArrayList<>());
