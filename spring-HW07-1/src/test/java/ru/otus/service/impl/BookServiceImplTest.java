...
class BookServiceImplTest {
    ...
    void setUp() {
        ...
        book = new Book("52a823d7-684a-43c6-8485-cdda3141e09c", "The Child of the Cavern",
                ...
                , new Author("fbddd6ac-f4dd-4a39-804d-03d45d30241b", "Jules Verne", new ArrayList<>())
                , comments);
    }
    ...
    @Transactional
    void shouldSaveBook() {
        Author rayBradbury = new Author("46a66c5d-4b74-47ce-90c5-1c4eee73c80f", "Ray Bradbury", new ArrayList<>());
        Genre novel = new Genre("e535b857-72e5-4d4e-9e65-e98201bc603d", "Novel", new ArrayList<>());
        Book bookForSave = new Book("ead42caa-d12a-4cb8-9e63-0896e911190b", "The Martian Chronicles ", novel, rayBradbury, new ArrayList<>());
        bookForSave.addComment(comment);
        bookForSave.addComment(comment2);
        ...
        assertEquals(savedBookResult.getAuthor().getName(), findBook.getAuthor().getName());
        assertEquals(savedBookResult.getGenre().getId(), findBook.getGenre().getId());
        assertEquals(savedBookResult.getGenre().getName(), findBook.getGenre().getName());
    ...
    @Transactional
    void updateBook() {
        Author dahl = new Author("eb50cd1b-397a-4f5e-8877-708718097438", "Roald Dahl", new ArrayList<>());
        Genre shortStory = new Genre("e01b9514-b49f-45fb-9e50-8b04cf701167", "short-story", new ArrayList<>());
        ...
        System.out.println("bookService ==> -------------------------------------");
        Author halls = new Author("b62bb71e-885e-4f2c-be09-2eef376ec18a", "Stacey Halls", new ArrayList<>());
        Genre novel = new Genre("e535b857-72e5-4d4e-9e65-e98201bc603d", "Novel", new ArrayList<>());
        ...
        System.out.println("bookService ==> -------------------------------------");
        assertEquals("Stacey Halls", updatedBookById.getAuthor().getName());
